...
<!-- Красная подсветка справа сверху -->
...
<!-- Персонаж GTAV — выше текста ASTRA и звёзд, но ниже кнопки играть (параллакс) -->
...
<!-- Звезда справа снизу -->
<svg class="absolute top-[410px] left-[702px] w-[258px] h-[230px] pointer-events-none select-none"
     viewBox="0 0 259 230" fill="none">
...
<!-- Звезда сверху -->
<svg class="absolute top-0 left-[106px] w-[323px] h-[156px] pointer-events-none select-none"
     viewBox="0 0 324 157" fill="none">
